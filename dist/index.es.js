...
var Emitter = /** @class */ (function () {
  ...
  Emitter.prototype.getRequest = function (reqID, keepRequestInStack) {
    if (keepRequestInStack === void 0) {
      keepRequestInStack = false;
    }
  ...
  default_1$$1.prototype.startSession = function () {
    ...
    return default_1.getJSON("/_auth/_jwtAuth").then(function (response) {
      ...
      if (response && response.hasOwnProperty("userUUID") && response.hasOwnProperty("jwtTicketID") &&
        ...
        return reject(new Error("Error Attempting to Authenticate and Authorise the WebSocket Session."));
      }
    });
  };
...
var default_1$4 = /** @class */ (function () {
  function default_1(namespace, alwaysProcessMessageWithDefaultHandler) {
    if (alwaysProcessMessageWithDefaultHandler === void 0) {
      alwaysProcessMessageWithDefaultHandler = false;
    }
  ...
  default_1.install = function (Vue, url, opts) {
    ...
    if (opts.connectManually) {
      Vue.prototype.$connect = function (connectionUrl, connectionOpts) {
        if (connectionUrl === void 0) {
          connectionUrl = url;
        }
        if (connectionOpts === void 0) {
          connectionOpts = opts;
        }
